  ...
  window.TOUR_ROUTES = {
    halfDay: {
      ...
      stops: [
        ...
        { id: "shishijiao", name: "石狮脚", x: 55.71, y: 73.93, markerOffsetX: -4.2, markerOffsetY: 3.2, labelSide: "left" }
      ]
    },
    fullDay: {
      id: "fullDay",
      ...
      stops: [
        ...
        { id: "longshi", name: "黄连龙虱馆", x: 37.45, y: 11.01, markerOffsetX: 4.2, markerOffsetY: 3.2 },
